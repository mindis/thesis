...
def preprocess():
    ratings_df = pd.read_csv('/home/nick/Desktop/thesis/datasets/ml-latest-small/ratings.csv')
    ...
    all_train_data.to_csv('/home/nick/Desktop/thesis/datasets/ml-latest-small/all_train.csv', sep='\t', index=False)
    train_data.to_csv('/home/nick/Desktop/thesis/datasets/ml-latest-small/train.csv', sep='\t', index=False)
    dev_data.to_csv('/home/nick/Desktop/thesis/datasets/ml-latest-small/dev.csv', sep='\t', index=False)
    test_data.to_csv('/home/nick/Desktop/thesis/datasets/ml-latest-small/test.csv', sep='\t', index=False)
